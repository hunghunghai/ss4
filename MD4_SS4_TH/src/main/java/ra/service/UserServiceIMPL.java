...
import ra.config.ConectionMysql;
...
ConectionMysql conection = new ConectionMysql();
    ...
    public boolean updateUser(User user) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = conection.getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL);) {
